...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="sidebar navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#">
                    <span>Ão khoÃ¡c</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#">
                    <span>Ão sÆ¡ mi</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#">
                    <span>Quáº§m dÃ i</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#">
                    <span>Quáº§n jeans</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#">
                    <span>Ão thun</span></a>
            </li>
        </ul>
        ...
        <div id="content-wrapper">
                            ...
                            <form action="/action_page.php">
                                ...
                                <div class="row">
                                    <div class="col-50">
                                        ...
                                        <label for="cellphone"><i class="fas fa-mobile-alt"></i> Cellphone</label>
                                        <input type="text" id="cellphone" name="cellphone" placeholder="01234567789" disabled>
                                    ...
                                    <div class="col-50">
                                       ...
                                       <c:forEach items="${paymentmethod }" var="paymentmethods">
                                        ...
                                        <label for="cname">
                                         ...
                                         <input type="checkbox" class="radio" value="1" name="fooby[1][]" />${ paymentmethods.methodname}
                                        </label>
                                       </c:forEach>
                                ...
                                <table class="table table-striped table-hover">
                                   ...
                                   <%--   <c:forEach items="${prdPayment }" var="prdPayment"> --%>
                                       <tr>
                                            ...
                                            <td><img class="img-product" src="data:image/jpg;base64,${prdPayment.base64}"></td>
            ...
            <div class="order-bill">
                <div class="detail-order-bill">
                    <div class="row-inf">
                            <span class="lbl">Total Money:</span>
                            <span class="fee">90$</span>
                    </div>
                    <div class="row-inf last-child">
                            <span class="lbl"><b>Payment:</b> </span>
                            <span class="fee"><b>90$</b> </span>
                    </div>
